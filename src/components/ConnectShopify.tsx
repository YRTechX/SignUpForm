            ...
            {data.shopify.shopify ? (
                <>
                    ...
                    <p className="text-gray-color mb-8 text-sm">
                        ...
                        it up to display your customers’ order information and
                        self-serve options.
                    </p>
                        ...
                        <ul className="flex flex-col gap-4">
                            <li className="flex gap-2">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <p className="text-gray-color text-xs">
                                        Global coverage with 600+ couriers
                                        supported
                                    </p>
                                </div>
                            </li>
                            <li className="flex gap-2">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <p className="text-gray-color text-xs">
                                        Allow customers to track, return,
                                        exchange, or report problems with their
                                        orders
                                    </p>
                                </div>
                            </li>
                            <li className="flex gap-2">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <p className="text-gray-color text-xs">
                                        Automatically checks your store policy
                                        and existing inventory before resolving
                                        or escalating each request
                                    </p>
                                </div>
                            </li>
                        </ul>
                ...
                <>
                    ...
                    <p className="text-gray-color mb-8 text-sm">
                        Chad Beta is currently only available on Shopify. We’ll
                        send you an email when Chad becomes available on your
                        platform.
                    </p>

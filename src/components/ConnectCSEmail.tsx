                ...
                <>
                    ...
                    {data.customer_support_email.gmail ? (
                                ...
                                <ul className="flex flex-col gap-4">
                                    ...
                                    <li className="flex gap-2">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <p className="text-gray-color text-xs">
                                                Respond to your customers via
                                                email or Chad chat—it’s all
                                    ...
                                    <li className="flex gap-2">
                                        ...
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <p className="text-gray-color text-xs">
                                                Tags your emails by category so
                                                you know what to expect before
                        ...
                        <>
                            ...
                            <p className="text-gray-color mb-8 text-sm">
                                Chad Beta is currently only integrated with
                                Gmail. We’ll send you an email when Chad becomes
                                compatible with your support ticket platform.
                            </p>
